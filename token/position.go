...
//
// The Pos value for a given file is a nubmer in the range [base, base+size],
...
// Line returns the line number of the given file position p;
...
type FileSet struct {
	...
	last  *File        // cache of last file hooked up
}
...
func (s *FileSet) file(p Pos) *File {
	s.mutex.RLock()
	// Common case: p is in the last file.
